// public/js/utils/icons.js - Enhanced Icon Component Library
  ...
  const icons = {
    ...
    settings: (
      ...
      >
        ...
        <path d="M17.196 3.804a8.969 8.969 0 0 1 0 12.392" />
        <path d="M6.804 3.804a8.969 8.969 0 0 0 0 12.392" />
      </svg>
    ),
    download: (
      <svg
    ...
    // NEUE ICONS für Fahrzeugverwaltung
    mapPin: (
      <svg
        width={iconSize}
        height={iconSize}
