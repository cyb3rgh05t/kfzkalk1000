...
// Moderne HTML Template mit SVG-Icons erstellen
...
async function setup() {
  try {
    // 1. Public Ordner erstellen
    const publicDir = path.join(__dirname, "public");
    if (!fs.existsSync(publicDir)) {
      fs.mkdirSync(publicDir);
      console.log("✅ Public Ordner erstellt");
    }

    // 2. HTML Datei mit modernen Icons erstellen
    const htmlPath = path.join(publicDir, "index.html");
    fs.writeFileSync(htmlPath, createFrontendHTML());
    console.log("✅ Frontend HTML mit modernen SVG-Icons erstellt");
    ...
    console.log(
      '\n💡 Tipp: Verwenden Sie "npm run dev" für Entwicklung mit Auto-Reload'
    );
    console.log("\n🎨 Features:");
    console.log("   ✅ Moderne SVG-Icons wie im professionellen Design");
    console.log("   ✅ Vollständige CRUD-Operationen für alle Bereiche");
    console.log("   ✅ SQLite Datenbank mit Beispieldaten");
    console.log("   ✅ Dark Mode Design");
    console.log("   ✅ Responsive Layout");
    console.log("   🆕 Kostenvoranschläge mit Status-Verwaltung");
    console.log('   🆕 "In Rechnung umwandeln" Funktion');
    console.log("   🆕 Erweiterte Dashboard-Statistiken");
  } catch (error) {
